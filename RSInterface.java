...
public final class RSInterface {
	...
	public static void TitleShop(TextDrawingArea TDA[]) {
		...
		addText(16477, "Currently viewing: Parabot Title Shop", TDA, 1,
				0xFF9900, false, true);
	...
	public static void CostumeShop(TextDrawingArea TDA[]) {
		...
		addText(40477, "Currently viewing: Parabot Costume Shop", TDA, 1,
				0xFF9900, false, true);
	...
	public static void RecolourShop(TextDrawingArea TDA[]) {
		...
		addText(44477, "Currently viewing: Parabot Recolour Shop", TDA, 1,
				0xFF9900, false, true);
	...
	public static void TaskShop(TextDrawingArea TDA[]) {
		...
		addText(34477, "Currently viewing: Parabot Task Shop", TDA, 1,
				0xFF9900, false, true);
	...
	public static void questTab(TextDrawingArea[] TDA) {
		...
		addHoverText(39164, "Www.Parabot.Net", "Register", TDA, 0, 16711680,
				false, true, 150);
		addText(39165, "Register on :", 16750623, false, true, 52, TDA, 0);
		addHoverText(39166, "Www.Parabot.Net", "Register", TDA, 0, 16711680,
				false, true, 150);
	...
	public static void achievemnttab(TextDrawingArea[] TDA) {
		...
		addHoverText(33164, "Www.Parabot.Net", "Register", TDA, 0, 16711680,
				false, true, 150);
		addText(33165, "Register on :", 16750623, false, true, 52, TDA, 0);
		addHoverText(33166, "Www.Parabot.Net", "Register", TDA, 0, 16711680,
				false, true, 150);
	 ...
	 * 150); addHoverText(29296, "Www.Parabot.Net", "", TDA, 0, 0xff0000, false,
	 * true, 150); addHoverText(29297, "And advertise/vote daily!", "", TDA, 0,
	 * 0xff0000, false, true, 150); addHoverText(29298,
	 * "::vote for more players!", "", TDA, 0, 0xff0000, false, true, 150);
	 * addHoverText(29299, "More players=More updates!", "", TDA, 0, 0xff0000,
	 * false, true, 150); addHoverText(29300, "", "", TDA, 0, 0xff0000, false,
	 * true, 150); addHoverText(29301, "", "", TDA, 1, 0xFF981F, false, true,
	 * 150); addHoverText(29302, "", "", TDA, 0, 0xff0000, false, true, 150);
	 ...
	 * addHoverText(29314, "", "", TDA, 0, 0xff0000, false, true, 150); } catch
	...
	public static void runecraftingTable(TextDrawingArea[] TDA) {
		...
		// Buttons Begin
		addHoverButton(27002, "Interfaces/runecraftingTable/SPRITE", 1, 82, 76,
				"Teleport to @gre@Air Altar", -1, 27002, 1);
		addHoverButton(27003, "Interfaces/runecraftingTable/SPRITE", 1, 82, 76,
				"Teleport to @gre@Mind Altar", -1, 27003, 1);
		addHoverButton(27004, "Interfaces/runecraftingTable/SPRITE", 1, 82, 76,
				"Teleport to @gre@Water Altar", -1, 27004, 1);
		addHoverButton(27005, "Interfaces/runecraftingTable/SPRITE", 1, 82, 76,
				"Teleport to @gre@Earth Altar", -1, 27005, 1);
		addHoverButton(27006, "Interfaces/runecraftingTable/SPRITE", 1, 82, 76,
				"Teleport to @gre@Fire Altar", -1, 27006, 1);
		addHoverButton(27007, "Interfaces/runecraftingTable/SPRITE", 1, 82, 76,
				"Teleport to @gre@Cosmic Altar", -1, 27007, 1);
		addHoverButton(27008, "Interfaces/runecraftingTable/SPRITE", 1, 82, 76,
				"Teleport to @gre@Chaos Altar", -1, 27008, 1);
		addHoverButton(27009, "Interfaces/runecraftingTable/SPRITE", 1, 82, 76,
				"Teleport to @gre@Astral Altar", -1, 27009, 1);
		addHoverButton(27010, "Interfaces/runecraftingTable/SPRITE", 1, 82, 76,
				"Teleport to @gre@Nature Altar", -1, 27010, 1);
		addHoverButton(27011, "Interfaces/runecraftingTable/SPRITE", 1, 82, 76,
				"Teleport to @gre@Law Altar", -1, 27011, 1);
		addHoverButton(27012, "Interfaces/runecraftingTable/SPRITE", 1, 82, 76,
				"Teleport to @gre@Death Altar", -1, 27012, 1);
		addHoverButton(27013, "Interfaces/runecraftingTable/SPRITE", 1, 82, 76,
				"Teleport to @gre@Blood Altar", -1, 27013, 1);
		addHoverButton(27014, "Interfaces/runecraftingTable/CLOSE", 1, 25, 25,
				"Close", -1, 27014, 1);
		// Buttons End
