public class BountyHunter {
	...
	static void bountyHunter(TextDrawingArea[] tda) {
		...
		RSInterface
				.addText(25349, "Target:", 0xffcccc, false, true, -1, tda, 0);
		RSInterface.addText(25350, "None", 0xff6666, true, true, -1, tda, 0);
		RSInterface.addText(25351, "Target likeihood", 0xffcccc, false, true,
				-1, tda, 0);
	...
	static void bountyHunter1(TextDrawingArea[] tda) {
		...
		RSInterface
				.addText(25355, "Target:", 0xffcccc, false, true, -1, tda, 0);
		RSInterface.addText(25356, "None", 0xff6666, true, true, -1, tda, 0);
		RSInterface.addText(25357, "Target likeihood", 0xffcccc, false, true,
				-1, tda, 0);
	...
	static void bountyHunter2(TextDrawingArea[] tda) {
		...
		RSInterface
				.addText(25361, "Target:", 0xffcccc, false, true, -1, tda, 0);
		RSInterface.addText(25362, "None", 0xff6666, true, true, -1, tda, 0);
		RSInterface.addText(25363, "Target likeihood", 0xffcccc, false, true,
				-1, tda, 0);
	...
	static void bountyHunter3(TextDrawingArea[] tda) {
		...
		RSInterface
				.addText(25367, "Target:", 0xffcccc, false, true, -1, tda, 0);
		RSInterface.addText(25368, "None", 0xff6666, true, true, -1, tda, 0);
		RSInterface.addText(25369, "Target likeihood", 0xffcccc, false, true,
				-1, tda, 0);
	...
	static void bountyHunter4(TextDrawingArea[] tda) {
		...
		RSInterface
				.addText(25373, "Target:", 0xffcccc, false, true, -1, tda, 0);
		RSInterface.addText(25374, "None", 0xff6666, true, true, -1, tda, 0);
		RSInterface.addText(25375, "Target likeihood", 0xffcccc, false, true,
				-1, tda, 0);
	...
	static void bountyHunter5(TextDrawingArea[] tda) {
		...
		RSInterface
				.addText(25379, "Target:", 0xffcccc, false, true, -1, tda, 0);
		RSInterface.addText(25380, "None", 0xff6666, true, true, -1, tda, 0);
		RSInterface.addText(25381, "Target likeihood", 0xffcccc, false, true,
				-1, tda, 0);
	...
	static void bountyHunter6(TextDrawingArea[] tda) {
		...
		RSInterface
				.addText(25385, "Target:", 0xffcccc, false, true, -1, tda, 0);
		RSInterface.addText(25386, "None", 0xff6666, true, true, -1, tda, 0);
		RSInterface.addText(25387, "Target likeihood", 0xffcccc, false, true,
				-1, tda, 0);
	...
	static void bountyHunter7(TextDrawingArea[] tda) {
		...
		RSInterface
				.addText(25391, "Target:", 0xffcccc, false, true, -1, tda, 0);
		RSInterface.addText(25392, "None", 0xff6666, true, true, -1, tda, 0);
		RSInterface.addText(25393, "Target likeihood", 0xffcccc, false, true,
				-1, tda, 0);
	...
	static void bountyHunter8(TextDrawingArea[] tda) {
		...
		RSInterface
				.addText(26391, "Target:", 0xffcccc, false, true, -1, tda, 0);
		RSInterface.addText(26392, "None", 0xff6666, true, true, -1, tda, 0);
		RSInterface.addText(26393, "Target likeihood", 0xffcccc, false, true,
				-1, tda, 0);
