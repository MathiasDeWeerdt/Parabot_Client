...
public final class EntityDef {
	...
	public static EntityDef forID(int i) {
		...
		if (i == 402) {
			...
			entityDef.description = "Official Parabot Melee Store.".getBytes();
		}
		...
		if (i == 7012) {
			...
			entityDef.description = "Official Parabot Range Store.".getBytes();
		}
		if (i == 884) {
			entityDef.itemActions = new String[5];
			...
			entityDef.description = "Official Parabot Guide.".getBytes();
		}
		...
		if (i == 7015) {
			...
			entityDef.description = "Official Parabot Mage Store.".getBytes();
		}
		...
		if (i == 883) {
			...
			entityDef.description = "Official Parabot Donator Store."
					.getBytes();
		}
		...
		if (i == 1861) {
			...
			entityDef.description = "Official Parabot Range Supplier."
					.getBytes();
		}
		if (i == 705) {
			entityDef.itemActions = new String[5];
			entityDef.itemActions[2] = "Trade";
			entityDef.name = "Melee Store";
			entityDef.description = "Official Parabot Melee Supplier."
					.getBytes();
		}
		if (i == 4707) {
			entityDef.itemActions = new String[5];
			...
			entityDef.description = "Official Parabot Magic Supplier."
					.getBytes();
		}
		...
		if (i == 4995) {
			...
			entityDef.aByte68 = 3;
			entityDef.readValues(stream); // Collect original NPC data
			entityDef.name = "@red@King @gre@Ace";
		...
		if (i == 42) {
			...
			entityDef.aByte68 = 3;
			entityDef.readValues(stream); // Collect original NPC data
			entityDef.name = "@or1@Parabot Masteer";
