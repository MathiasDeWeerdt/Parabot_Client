...
public final class ObjectDef {
	...
	public static void unpackConfig(StreamLoader streamLoader) {
		/*
		 * stream = new Stream(streamLoader.getDataForName("loc.dat")); Stream
		 * stream = new Stream(streamLoader.getDataForName("loc.idx"));
		 * FileOperations.WriteFile("" + signlink.findcachedir() + "loc.dat",
		 * streamLoader.getDataForName("loc.dat")); FileOperations.WriteFile(""
		 * + signlink.findcachedir() + "loc.idx",
		 * streamLoader.getDataForName("loc.idx"));
		 */
		stream = new Stream(FileOperations.ReadFile(signlink.findcachedir()
				+ "loc.dat"));
		Stream stream = new Stream(FileOperations.ReadFile(signlink
				.findcachedir() + "loc.idx"));
